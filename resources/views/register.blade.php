                            ...
                            @csrf
                              <div class="form-group">
                                ...
                                <input type="text" name="nama"
                                  class="form-control"id="" aria-describedby="helpId" placeholder="" autofocus required autocomplete="off">
                              </div>
                              <div class="form-group">
                                <label for="">Email</label>
                                <input type="email" name="email"
                                  class="form-control" id="" aria-describedby="helpId" placeholder="" required autocomplete="off">
                              </div>
                              <div class="form-group">
